; ModuleID = 'test/non_rotated/hard.m2r.ll'
...
22:                                               ; preds = %2
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %.04)
  %24 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %.03)
  %25 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %.06)
  %26 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %.0)
  ret void
}
